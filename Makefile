...
PACKAGE ?= configuration-aws-ipv6-ula-network-allocation
XRD_DIR := apis/ipv6ulanetworkallocations
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/ipv6ulanetworkallocations/standard.yaml
...
EXAMPLES := \
    examples/ipv6ulanetworkallocations/minimal.yaml:: \
    examples/ipv6ulanetworkallocations/standard.yaml:: \
    examples/ipv6ulanetworkallocations/custom-sizes.yaml:: \
    examples/ipv6ulanetworkallocations/standard.yaml::examples/test/mocks/observed-resources/standard/steps/1/ \
    examples/ipv6ulanetworkallocations/standard.yaml::examples/test/mocks/observed-resources/standard/steps/2/ \
    examples/ipv6ulanetworkallocations/standard.yaml::examples/test/mocks/observed-resources/standard/steps/3/
...
render\:%:
	@example="examples/ipv6ulanetworkallocations/$*.yaml"; \
	if [ -f "$$example" ]; then \
		echo "=== Rendering $$example ==="; \
		up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example; \
	else \
